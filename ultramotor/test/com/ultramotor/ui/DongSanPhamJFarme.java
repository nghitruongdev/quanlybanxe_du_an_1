 ...
 * @author thaian
 */
public class DongSanPhamJFarme extends javax.swing.JFrame {

    /** Creates new form DongSanPhamPanel */
    public DongSanPhamJFarme() {
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DongSanPhamJFarme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DongSanPhamJFarme().setVisible(true);
            }
        });
    }
