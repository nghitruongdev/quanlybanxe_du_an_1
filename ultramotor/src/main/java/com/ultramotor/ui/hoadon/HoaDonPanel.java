...
public class HoaDonPanel extends javax.swing.JPanel {
    ...
    private void updateStatus() {
        boolean done = Status.getStatus(txtTrangThai.getText()) == Status.HOAN_TAT;
        btnResetKH.setEnabled(!done);
...
//        currentHD.setGiamGia(txtGiamGia.getText().equals("") ? 0 : Integer.parseInt(txtGiamGia.getText().replace("%", "")));

//        txtThue.setText(numberFormat.format(currentHD.getThue()));
//        txtTongTien.setText(numberFormat.format(currentHD.getTongTien() + currentHD.getThue()));
    ...
    private void printHD(HoaDon hd) {
        ...
        try {
            XReport.printHoaDon(hd.getIdHD(), file);
...
//        JTextField field = (JTextField) cboTrangThai.getEditor().getEditorComponent();
//        field.setDisabledTextColor(Color.red);
    ...
    private void initComponents() {
        ...
        btnThemCTHD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ultramotor/icon/broom_25px.png"))); // NOI18N
        ...
        btnSearchSP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ultramotor/icon/search_client_25px.png"))); // NOI18N
                ...
                .addGroup(pnlInfoSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlInfoSanPhamLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlInfoSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlInfoSanPhamLayout.createSequentialGroup()
                                .addComponent(btnResetSP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
