...
//            return;
    ...
    private void addMenus(NhanVien user) {
        String path = "./src/com/ultramotor/img/icon/%s";
        ...
        ModelMenu mnuNhanVien = new ModelMenu("Quản lý nhân viên", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("NhanVien"));
        ModelMenu mnuHoaDon = new ModelMenu("Quản lý hoá đơn", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("HoaDon"));
        ModelMenu mnuKhachHang = new ModelMenu("Quản lý khách hàng", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("KhachHang"));
        ModelMenu mnuSanPham = new ModelMenu("Quản lý sản phẩm", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("SanPham"));
        ModelMenu mnuNhapKho = new ModelMenu("Quản lý kho", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("NhapKho"));
        ModelMenu mnuBarcode = new ModelMenu("In barcode", new ImageIcon(String.format(path, "refresh_25px.png")), getEvent("Barcode"));
