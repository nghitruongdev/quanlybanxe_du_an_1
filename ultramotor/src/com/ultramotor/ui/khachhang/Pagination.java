...
public class Pagination extends JComponent {
    ...
    public void setTotalPage(int totalPage) {
        ...
        for (int i = 0; i < totalPage; i++) {
            add(new Item(i, colorMap.getOrDefault(colors[i], Color.black), event), "w 100%, h 100%");
        }
        repaint();
        revalidate();
    }
...
//    }
    ...
    public Pagination() {
        layout = new MigLayout("insets 5", "[fill, center]10[fill,center]");
        setLayout(layout);
    }
}
