...
//    }
    ...
    private void deleteCTHD(SanPham sp, boolean ask) {
        ...
        if (index >= 0) {
            ((DefaultTableModel) tblChiTiet.getModel()).removeRow(index);
    ...
    void insertRow(Table table, Entity e) {
        ((DefaultTableModel) table.getModel()).addRow(getInfo(e));
    }
    ...
    private void huyHoaDon() {
        if (currentHD == null) {
            System.out.println("Hiện tại không có hoá đơn");
            return;
        }
    ...
    private void initComponents() {
            ...
            .addGroup(pnlCTHDLayout.createSequentialGroup()
                ...
                .addGroup(pnlCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlCTHDLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnThanhToan1, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlCTHDLayout.setVerticalGroup(
            ...
            .addGroup(pnlCTHDLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(pnlCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnLuu, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnThanhToan1, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnHuyHD, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18))
        );

        pnlHoaDon.add(pnlCTHD, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 10, 620, 330));
        ...
        if (validateKH()) {
            try {
                ...
                return new KhachHang(
                        txtMaKH.getText(),
                        hoten.substring(0, hoten.indexOf(' ')),
                        hoten.substring(hoten.indexOf(' ') + 1),
